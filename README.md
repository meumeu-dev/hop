...
L'installeur place `hop.exe` dans `%LOCALAPPDATA%\hop` et ajoute le dossier au PATH utilisateur. Réouvre PowerShell, puis `hop config`. Désinstallation : `hop uninstall`.
